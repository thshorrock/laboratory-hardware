...
main  (int ac, char **av)
{
  ...
  std::cin>> c; 
    ...
    for(size_t i = 0;i<different_driving_voltages;++i){
...
//create a readme file in the directory.
	...
	ICR::file Filename_GP(dir,"pulse_echo_short_var_gain"+index+"_GP.dat");
	...
	("-----------------------")
	("The first three alines are separated as these sometimes contain bubbles, and would like to save examples of these - ")
	("-----------------------")
	...
	ICR::file Filename_GP(dir,"pulse_echo_short_var_gain_"+index+"_GP.dat");
