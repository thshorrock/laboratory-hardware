...
main  (int ac, char **av)
{
  ...
  std::cin>> c; 
    ...
    for(size_t i = 29;i<different_driving_voltages;++i){
...
//create a readme file in the directory.
      ...
      scope.volts_per_div(location::C3, 2.5*lecroy_volts_per_div);
      //image the first 20
