...
double driving_voltage = 491.0e-3;

double driving_min_voltage = 20e-3;
double driving_max_voltage = 0.5;
bool failed = true;
...
main  (int ac, char **av)
{
  ...
  while( driving_voltage<driving_max_voltage) {
    ...
    try{
      ...
      ICR::directory dir("/data/2011/01/08");  //the current directory
	...
	eq.driving_pulse.turn_on();
      ...
      eq.lecroy_volts_per_div = 230e-3;
